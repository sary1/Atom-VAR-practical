...
public class FirstPlatformElectrons : MonoBehaviour
{
    ...
    void Update()
    {
        if (GlobalVariables.FirstLevelElectrons == 0)
        {
            Electron1.SetActive(false);
            Electron2.SetActive(false);
            Electron3.SetActive(false);
        ...
        else if (GlobalVariables.FirstLevelElectrons == 1)
        {
        ...
        else if (GlobalVariables.FirstLevelElectrons == 2)
        {
            Electron1.SetActive(true);
        ...
        else if (GlobalVariables.FirstLevelElectrons == 3)
        {
            Electron1.SetActive(true);
            Electron2.SetActive(true);
        ...
        else if (GlobalVariables.FirstLevelElectrons == 4)
        {
            Electron1.SetActive(true);
            Electron2.SetActive(true);
            Electron3.SetActive(true);
        ...
        else if (GlobalVariables.FirstLevelElectrons == 5)
        {
            Electron1.SetActive(true);
            Electron2.SetActive(true);
            Electron3.SetActive(true);
        ...
        else if (GlobalVariables.FirstLevelElectrons == 6)
        {
            Electron1.SetActive(true);
            Electron2.SetActive(true);
            Electron3.SetActive(true);
        ...
        else if (GlobalVariables.FirstLevelElectrons == 7)
        {
            Electron1.SetActive(true);
            Electron2.SetActive(true);
            Electron3.SetActive(true);
        ...
        else if (GlobalVariables.FirstLevelElectrons == 8)
        {
            Electron1.SetActive(true);
            Electron2.SetActive(true);
            Electron3.SetActive(true);
